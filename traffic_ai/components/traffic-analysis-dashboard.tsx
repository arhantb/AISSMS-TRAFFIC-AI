                  ...
                  >
                    <Tooltip direction="top" offset={[0, -10]} opacity={0.9}>
                      <div className="text-center">
                        ...
                        <div className="text-sm">{city.congestion}% congestion</div>
                      </div>
                    </Tooltip>
                    <Popup>
                      <div className="p-2">
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-sm text-gray-600">{city.congestion}% congestion</div>
                      </div>
                      <div
                    ...
                    >
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm font-medium">{city.congestion}%</span>
                        </div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setSelectedCity(
                        indianCities.find((c) => c.id === Number(e.target.value)) || null
                      )
                    }
                  >
                    ...
                    <tbody className="divide-y divide-gray-200">
                      <tr>
                        ...
                        <td className="px-6 py-4 text-center">
                          <span
                            className="inline-flex items-center justify-center w-10 h-10 rounded-full text-white font-bold"
                            style={{ backgroundColor: getColorByRank(compareCity.rank) }}
                          >
                            {compareCity.rank}
                          </span>
                        </td>
                        ...
                        <td className="px-6 py-4 text-center">
                          <div className="space-y-2">
                            ...
                            <div className="flex items-center justify-center gap-2">
                              ...
                              <span className="text-sm">Rush: {selectedCity.rushDistance} km</span>
                            </div>
                          </div>
                        </td>
                        <td className="px-6 py-4 text-center">
                          <div className="space-y-2">
                            ...
                            <div className="flex items-center justify-center gap-2">
                              <div className="w-3 h-3 rounded-full bg-red-600"></div>
                              <span className="text-sm">Rush: {compareCity.rushDistance} km</span>
                            </div>
                          </div>
                        </td>
                      </tr>
          ...
          <div className="mt-6 bg-white rounded-lg shadow-sm p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="bg-gray-50 rounded-lg p-4">
                <div className="text-sm text-gray-600 mb-1">Congestion Level</div>
                <div className="text-2xl font-bold text-gray-900">{selectedCity.congestion}%</div>
                <div className="text-xs text-gray-500 mt-1">
                  {selectedCity.change > 0 ? '↑' : '↓'} {Math.abs(selectedCity.change)} pp from
                  2024
                </div>
              </div>
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <div className="text-2xl font-bold text-gray-900">{selectedCity.avgSpeed} km/h</div>
              </div>

              <div className="bg-gray-50 rounded-lg p-4">
                <div className="text-sm text-gray-600 mb-1">Time Lost in Rush Hours</div>
                <div className="text-2xl font-bold text-gray-900">{selectedCity.timeLostInRushHours}h</div>
            ...
            <div className="mt-6 pt-6 border-t border-gray-200">
              <h3 className="font-semibold text-gray-900 mb-4">Distance in 15 Minutes</h3>
              <div className="space-y-3">
                <div>
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-sm font-bold">{selectedCity.optimalDistance} km</span>
                  </div>
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div
                      className="bg-blue-500 h-2 rounded-full"
                      style={{ width: `${(selectedCity.optimalDistance / 10) * 100}%` }}
                    />
                  </div>
                </div>
                <div>
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-sm font-bold">{selectedCity.rushDistance} km</span>
                  </div>
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div
                      className="bg-red-600 h-2 rounded-full"
                      style={{ width: `${(selectedCity.rushDistance / 10) * 100}%` }}
                    />
                  </div>
                </div>
              </div>
